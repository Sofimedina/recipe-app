...
public class DataLoader implements CommandLineRunner {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), unitOfMeasureRepository.findByDescription("Teaspoon").get()));
...
//        tacosRecipe.addIngredient(new Ingredient("Dried Oregano", new BigDecimal(1), unitOfMeasureRepository.findByDescription("Teaspoon").get()));
